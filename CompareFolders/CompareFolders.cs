...
namespace CompareFolders
{
    public static class CompareFolders
    {
        ...
        private static void Main(string[] args)
        {
            ...
            //#region Start
            //HashFilesTables fileTable = new HashFilesTables(args[0], args[1]);
            ...
            //PrintResult();
            HashFilesTables hashFilesTables = new HashFilesTables(args);
            hashFilesTables.Begin();
        }
        ...
        //    Console.WriteLine($"Время выполнения (чч:мм:сс:мс):");
